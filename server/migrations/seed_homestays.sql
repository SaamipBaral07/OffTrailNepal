...
INSERT INTO homestays (host_id, trail_id, name, location, price_per_night, capacity, description, verified_status, latitude, longitude, is_active, contact_phone, amenities, total_rooms, available_rooms, google_map_iframe_link)
VALUES
  ...
  'pending', 28.37190000, 83.80210000, true, '+977-9841234567', ARRAY['WiFi', 'Hot Shower', 'Breakfast', 'Mountain View'], 8, 5, 'https://www.google.com/maps'),
  ...
  'pending', 28.38530000, 83.82450000, true, '+977-9841234568', ARRAY['Solar Hot Water', 'Heater', 'Dinner Included'], 10, 10, 'https://www.google.com/maps'),
  ...
  'pending', 28.35670000, 83.81340000, true, '+977-9841234569', ARRAY['Attached Bathroom', 'Laundry'], 5, 0, 'https://www.google.com/maps');
