...
// ╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET  /api/bookings/my                            → bookingRoutes.js      → bookingController.getMyBookings       ║
// ║ GET  /api/guide-bookings/my                      → guideBookingRoutes.js → guideBookingController.getMyGuideBookings║
// ║ PATCH /api/bookings/:bookingId/cancel            → bookingRoutes.js      → bookingController.cancelBooking       ║
// ║ POST /api/bookings/:bookingId/refund/request     → bookingRoutes.js      → bookingController.requestBookingRefund║
// ║ POST /api/guide-bookings/:bookingId/refund/request → guideBookingRoutes.js → guideBookingController.requestGuideBookingRefund║
// ║ POST /api/bookings/:bookingId/review             → bookingRoutes.js      → bookingController.submitBookingReview ║
// ║ POST /api/guide-bookings/:bookingId/review        → guideBookingRoutes.js → guideBookingController.submitGuideReview  ║
// ║ GET  /api/invoices/:bookingType/:bookingId        → invoiceRoutes.js      → invoiceController.getInvoiceByBooking ║
// ╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝
