// ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET    /api/wishlist                    → wishlistRoutes.js → wishlistController.getWishlistItems      ║
// ║ DELETE /api/wishlist/:itemType/:itemId  → wishlistRoutes.js → wishlistController.removeWishlistItem    ║
// ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
