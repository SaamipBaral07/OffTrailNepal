// ╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET  /api/homestays/public/:id                → homestayRoutes.js  → homestayController.getPublicHomestayById║
// ║ POST /api/bookings/payment/stripe/initiate    → bookingRoutes.js   → bookingController.initiateStripePayment ║
// ║ POST /api/bookings/payment/initiate           → bookingRoutes.js   → bookingController.initiatePayment       ║
// ║ GET  /api/bookings/payment/session/:token     → bookingRoutes.js   → bookingController.getPaymentSession     ║
// ║ GET  /api/auth/csrf-token                     → authRoutes.js      → authController.getCsrfToken             ║
// ║ POST /api/bookings/payment/verify             → bookingRoutes.js   → bookingController.verifyPayment         ║
