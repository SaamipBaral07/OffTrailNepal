...
// ╠═════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET   /api/contact/enquiries/my-replies         → contactRoutes.js → contactController.getMyContactEnquiryReplies
// ║ PATCH /api/contact/enquiries/my-replies/mark-read → contactRoutes.js → contactController.markMyContactEnquiryRepliesAsRead
// ║ GET   /api/contact/testimonials/me              → contactRoutes.js → contactController.getMyTouristPlatformReview
// ║ POST  /api/contact/enquiries                    → contactRoutes.js → contactController.submitContactEnquiry      
// ║ POST  /api/contact/testimonials                 → contactRoutes.js → contactController.submitTouristPlatformReview
// ╚═════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
