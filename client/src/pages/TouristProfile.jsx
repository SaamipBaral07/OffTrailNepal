// ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET   /api/auth/tourist/profile  → authRoutes.js → authController.getTouristProfile               ║
// ║ PATCH /api/auth/profile-photo    → authRoutes.js → authController.updateProfilePhoto              ║
// ║ PATCH /api/auth/tourist/profile  → authRoutes.js → authController.updateTouristProfile            ║
// ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
