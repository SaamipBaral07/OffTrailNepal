...
// ╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET    /api/homestays/my                          → homestayRoutes.js → homestayController.getMyHomestays      
// ║ GET    /api/bookings/host                         → bookingRoutes.js  → bookingController.getHostBookings     
// ║ GET    /api/homestays/host/verification-status    → homestayRoutes.js → hostVerificationController.getMyHostVerificationStatus
// ║ POST   /api/homestays/host/verification-docs      → homestayRoutes.js → hostVerificationController.submitHostVerificationDocs
// ║ GET    /api/homestays/trails                      → homestayRoutes.js → homestayController.getTrailsForHost    
// ║ GET    /api/homestays/amenities                   → homestayRoutes.js → homestayController.getHomestayAmenityCatalog
// ║ POST   /api/homestays                             → homestayRoutes.js → homestayController.createHomestay      ║
// ║ PUT    /api/homestays/:id                         → homestayRoutes.js → homestayController.updateHomestay      ║
// ║ DELETE /api/homestays/:id                         → homestayRoutes.js → homestayController.deleteHomestay      ║
// ║ PATCH  /api/homestays/:id/toggle-active           → homestayRoutes.js → homestayController.toggleHomestayActive║
// ║ PATCH  /api/homestays/:id/rooms                  → homestayRoutes.js → homestayController.updateHomestayAvailableRooms
// ║ DELETE /api/homestays/:id/images/:imageId         → homestayRoutes.js → homestayController.deleteHomestayImage ║
// ║ PATCH  /api/homestays/:id/images/:imageId/primary → homestayRoutes.js → homestayController.setHomestayPrimaryImage║
// ╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝

import { useEffect, useState, useCallback, useMemo } from "react";
import { Link, useNavigate } from "react-router-dom";
// line number 1331 , logic starts
    ...
    >
      ...
      <div className="flex items-start justify-between relative z-10">
        <div>
          ...
          <p className="text-3xl font-bold text-g-900 font-heading tracking-tight group-hover:text-[#0A192F] transition-colors">{value}</p>
