...
// ╠══════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET /api/contact/testimonials/featured → contactRoutes.js → contactController.getFeaturedTestimonials ║
// ║ GET /api/trails/public                 → trailRoutes.js   → trailController.getPublicTrails           ║
// ╚══════════════════════════════════════════════════════════════════════════════════════════════════════╝
...
const stats = [
  { value: "100+", label: "Curated Trails", icon: Mountain },
  { value: "50+", label: "Expert Guides", icon: Compass },
  { value: "4,000+", label: "Happy Trekkers", icon: Users },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {trails.length > 6 && (
            ...
            >
              <Link
                to="/trails"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 text-lg font-bold text-white rounded-xl shadow-lg shadow-gold/20 hover:shadow-xl hover:shadow-gold/40 hover:scale-[1.02] transition-all duration-300"
                style={{
                  background:
                    "linear-gradient(135deg, #C8932A 0%, #E0B04A 100%)",
                }}
              >
                Click to Explore More Trails
                <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </motion.div>
          )}
