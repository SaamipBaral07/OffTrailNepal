...
// ║                                                                                 
// ╠═════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET    /api/ai-chat/conversations                    → aiChatRoutes.js → aiChatController.getMyConversations     ║
// ║ GET    /api/ai-chat/conversations/:id/messages       → aiChatRoutes.js → aiChatController.getMyConversationMessages║
// ║ POST   /api/ai-chat/message                          → aiChatRoutes.js → aiChatController.sendChatMessage        ║
// ║ DELETE /api/ai-chat/conversations/:conversationId    → aiChatRoutes.js → aiChatController.deleteConversation    ║
// ╚═════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
