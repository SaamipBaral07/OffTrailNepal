// ╠═════════════════════════════════════════════════════════════════════════════════════════════════════╣
// ║ GET   /api/auth/host/profile      → authRoutes.js → authController.getHostProfile                   ║
// ║ PATCH /api/auth/profile-photo     → authRoutes.js → authController.updateProfilePhoto                ║
// ║ PATCH /api/auth/host/profile      → authRoutes.js → authController.updateHostProfile                 ║
// ║ PATCH /api/auth/host/bank-details → authRoutes.js → authController.updateHostBankDetails             ║
// ║ (via ChangePasswordCard component)                                                                  ║
// ║ PATCH /api/auth/host/password     → authRoutes.js → authController.updateHostPassword                ║
// ╚═════════════════════════════════════════════════════════════════════════════════════════════════════╝
