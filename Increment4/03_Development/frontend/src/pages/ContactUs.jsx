    ...
    <div className="min-h-screen bg-gradient-to-b from-cream via-[#f8f6f2] to-[#f1ece2]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        ...
        <section className="mt-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 shadow-sm">
            <div className="mb-3 flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Visit us for partnership meetings, issue resolution, and travel-planning consultations.</p>
              </div>
              <a
            ...
            <div className="relative h-[320px] sm:h-[420px] w-full overflow-hidden rounded-2xl border border-gray-200 bg-gray-100">
              <iframe
          ...
          <div className="lg:col-span-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm flex flex-col">
            <h3 className="text-base font-bold text-navy">Before You Reach Out</h3>
            <p className="text-sm text-gray-600 mt-2 leading-relaxed">
              For faster support, mention trail name, booking code, travel dates, and your preferred callback time.
            </p>

            <div className="mt-4 space-y-3">
              <div className="rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-3">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">Support Window</p>
                <p className="text-sm font-semibold text-charcoal mt-1">Mon to Sat, 9:00 AM to 6:00 PM (NPT)</p>
              </div>
              <div className="rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-3">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">Email</p>
                <p className="text-sm font-semibold text-charcoal mt-1 break-words">info@offtrailnepal.com</p>
              </div>
              <div className="rounded-xl border border-stone-200 bg-stone-50 px-3.5 py-3">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">Phone</p>
                <p className="text-sm font-semibold text-charcoal mt-1">+977-01-4XXXXXX</p>
              </div>
            </div>
          </div>
        </section>
